...
public class PersonServices {
	...
	@Autowired
	PersonMapperV2 personMapperVOV2;
	...
	public PersonVOV2 createPersonV2(PersonVOV2 person) {
		logger.info("Creating one person with V2 route!");
		
		Person entity = personMapperVOV2.converVOToEntity(person);
		
		return personMapperVOV2.convertEntityToVO(repository.save(entity));
	}
